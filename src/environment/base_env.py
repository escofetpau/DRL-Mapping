...
class BaseGraphSeriesEnv(gym.Env):
    def __init__(
        ...
        if self.random_circuits:
            ...
            circuit = circuit_config["circuit"]
        ...
        self.action_space = (
            ...
            if self.action_type == ACTION_TYPES[0]
            else spaces.Discrete(self.n_qbits * self.n_cores)
        )

        self.qbit_idx = 0 if action_type == ACTION_TYPES[0] else None
    ...
    def _get_reward(self, nl_com, intervention, direct_capacity_violation):
        self.nl_com = nl_com
    ...
    def _set_slice(self):
        ...
        self.lookahead = self.lookahead[self.slice_idx]
